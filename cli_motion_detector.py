...
def send_notification_photo(photo_path):
    ...
    try:
        ...
        with open(photo_path, 'rb') as photo_file:
            bot.sendPhoto(chat_id, photo=photo_file, caption="Someone is on the door.")
...
def send_notification_video(video_path):
    ...
    try:
        ...
        with open(video_path, 'rb') as video_file:
            bot.sendVideo(chat_id, video=video_file, caption="Someone is on the door.")
...
def record_video(start_time):
    ...
    try:
        ...
        out = cv2.VideoWriter(video_path, cv2.VideoWriter_fourcc(*'mp4v'), 12, (960, 1080))
